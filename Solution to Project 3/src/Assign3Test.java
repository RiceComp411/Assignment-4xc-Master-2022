...
//      e.printStackTrace();
  ...
  public void testInfiniteListEq1() {
    String output = null;
    String input = "let ones = cons(1, ones); in ones = ones";
    try {
      valueNameCheck("InfiniteListEq1", input, output);
      fail("ininite list equality test did not diverge");
    }
    catch(VirtualMachineError|Exception e) {
      /* test exhausted stack as expected */
    }
    try {
      valueNeedCheck("InfiniteListEq1", input, output);
      fail("ininite list equality test did not diverge");
    }
    catch(VirtualMachineError|Exception e) {
      /* test exhausted stack as expected */
    ...
    try {
      nameNameCheck("InfiniteListEq1", input, output);
      fail("ininite list equality test did not diverge");
    }
    catch(VirtualMachineError|Exception e) {
      /* test exhausted stack as expected */
    ...
    try {
      nameNeedCheck("InfiniteListEq1", input, output);
      fail("ininite list equality test did not diverge");
    }
    catch(VirtualMachineError|Exception e) {
      /* test exhausted stack as expected */
    ...
    try {
      needNameCheck("InfiniteListEq1", input, output);
      fail("ininite list equality test did not diverge");
    }
    catch(VirtualMachineError|Exception e) {
      /* test exhausted stack as expected */
    ...
    try {
      needNeedCheck("InfiniteListEq1", input, output);
      fail("ininite list equality test did not diverge");
    }
    catch(VirtualMachineError|Exception e) {
      /* test exhausted stack as expected */
  ...
  public void testInfiniteListEq2() {
    String output = "false";
    String input = "let ones := cons(1, ones); " +
                   " notOnes := cons(1, cons(1, cons(0, ones))); " +
                   "in ones = notOnes"; 
    try {
      lazyCheck("InfiniteListEq1", output, input);
    }
    catch(VirtualMachineError|Exception e) {
      fail("valid lazy = check threw Exception" + e);
    }
  }
